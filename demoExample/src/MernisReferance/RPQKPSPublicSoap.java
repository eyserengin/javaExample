...
public class RPQKPSPublicSoap
{
    ...
    public RPQKPSPublicSoap(){}

    public RPQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RPQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RPQExtendedSoapSerializationEnvelope envelope= new RPQExtendedSoapSerializationEnvelope(RPQExtendedSoapSerializationEnvelope.VER11);
